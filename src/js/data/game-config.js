 ...
 *   stars   通关奖励星星
 *   source  出题学段：'l1'=小学词库 'l2'=初中词库 'l3'=高中词库
 *           （不写则从全库随机取词）
 * ============================================================================ */
(function (GameConfig) {
  'use strict';
  ...
  GameConfig.levels = [
    { id: 1, name: '小学入门', desc: '6对单词 · 一二年级词库', pairs: 6,  cols: 4, stars: 3, source: 'l1' },
    { id: 2, name: '初中进阶', desc: '8对单词 · 七八九年级词库', pairs: 8,  cols: 4, stars: 4, source: 'l2' },
    { id: 3, name: '高中冲刺', desc: '10对单词 · 高一至高三词库', pairs: 10, cols: 5, stars: 6, source: 'l3' }
  ];
